          ...
          <div class="d-flex justify-content-between">
            ...
            >
                  ...
                  <div class="noti-scroll" data-simplebar>
                      ...
                      <p class="mb-0 user-msg">
                        <small class="fs-14"
                          ...
                          <span class="text-reset"
                            >Improve workflow in Figma</span
                          ></small
                        >
                      </p>
                    </a>
                    ...
                    >
                      ...
                      <div class="notify-content">
                        ...
                        <p class="noti-mentioned p-2 rounded-2 mb-0 mt-2">
                          <span class="text-primary">@Patryk</span> Please make
                          sure that you're....
                        </p>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <p class="mb-0 user-msg">
                        <small class="fs-14"
                          >Completed
                          <span class="text-reset"
                            >Improve workflow in React</span
                          ></small
                        >
                      </p>
                    </a>
                    ...
                    >
                      ...
                      <div class="notify-content">
                        ...
                        <p class="noti-mentioned p-2 rounded-2 mb-0 mt-2">
                          <span class="text-reset">@Patryk</span> Please make
                          sure that you're....
                        </p>
                      </div>
                    </a>
              ...
              <li class="dropdown notification-list topbar-dropdown">
                ...
                >
                  <img
                    src= "{{asset('backend/assets/images/users/user-16.jpg')}}"
                    alt="user-image"
                    class="rounded-circle"
                  />
                  <span class="pro-user-name ms-1">
                    Hassan <i class="mdi mdi-chevron-down"></i>
                  </span>
                </a>
